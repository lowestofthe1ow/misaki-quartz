...
[[CCICOMP/Data_representation#Data types|Data types]] in C store values within specific ranges. The type affects how the variable is stored and what operations can be performed on the variable.

At the moment, the data types that we consider are [[CCICOMP/Data_representation#Integers|integers]], [[CCICOMP/Data_representation#Floating-point numbers|floating-point numbers]], and [[CCICOMP/Data_representation#Characters|characters]].
