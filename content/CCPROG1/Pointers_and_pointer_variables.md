...
The value stored at the address of the pointer must be a value of the **same** [[CCICOMP/Data_representation#Data types|type]] as the type of variable the pointer "points" to.
<!--ID: 1695827832802-->
...
- Dereferencing with an **invalid** [[CCICOMP/Data_representation#Data types|type]] cast will have the potential to cause a crash.
